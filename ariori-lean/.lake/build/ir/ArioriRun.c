...
extern "C" {
#endif
lean_object* lp_ariori_arioriMain();
...
LEAN_EXPORT lean_object* initialize_ariori_ArioriRun(uint8_t builtin) {
lean_object * res;
...
int main(int argc, char ** argv) {
  ...
  res = initialize_ariori_ArioriRun(1 /* builtin */);
